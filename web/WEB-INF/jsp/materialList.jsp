            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h1 class="h3 media-heading">Add Lecture Resources</h1>
                    ...
                    <p>
                      Lecturers can add and delete lacture resources to complement the one previously added by the admin.</p>
                    <form action="#">
                    <span class="label bg-lightred"> <input type="file" name="materials" accept="image/*"></span>
            ...
            <div class="panel panel-default curriculum open">
              <div class="panel-heading panel-heading-gray" data-toggle="collapse" data-target="#curriculum-1">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h4 class="media-heading">List of materials</h4>
